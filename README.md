# EventCatalog Generators that support Declarative Configuration

This project include a system that allows you to manage EventCatalog generator configurations declaratively via YAML files, eliminating the need to manually edit `eventcatalog.config.js`.
